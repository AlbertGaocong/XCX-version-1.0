...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this;
    var tempSize = wx.getSystemInfoSync();
    that.setData({
      sizeHeight : tempSize.windowHeight + 'px',
    })
    // var size = this.setCanvasSize();//动态设置画布大小
    var tempJson = JSON.stringify({
    "LoginAccountCode": user.code,
    "LoginAccountMobile": user.mobile
});
    this.createQrCode(tempJson, "mycanvas", 150, 150);
